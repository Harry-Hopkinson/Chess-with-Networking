...
Once submitted, I will recieve your report. I will try to answer as quickly as possible but if I am not avaliable, I may take a while for an answer.

## Contributing Fixes

If you are interested in writing code to fix issues, fork the project and open a pull request. I will review the code and authorise it into the code.
